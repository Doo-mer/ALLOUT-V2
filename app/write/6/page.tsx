      ...
      <Container>
        ...
        <Column className="flex-1 justify-between p-4">
          ...
          <div className="space-y-4  mb-[1rem]">
            <SubTitle>그 일에 대해 왜곡된 생각을 가지고 있나요?</SubTitle>
            ...
            <textarea
              ...
              className="w-full h-40 p-3 bg-neutral-900 rounded-lg resize-none focus:outline-none"
            />
          </div>

          {/* Next Button */}
          <PrimaryButton href="/write/7" disabled={!thoughts || thoughts.trim() === ''}>다음</PrimaryButton>
        </Column>
      </Container>
    </App>
  )
